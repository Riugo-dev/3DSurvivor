...
private:
	...
	ID3D11ShaderResourceView* m_ShurikenSummary;//背景画
	ID3D11ShaderResourceView* m_SwordSummary;//文字
	ID3D11ShaderResourceView* m_BulletSummary;//背景画
	ID3D11ShaderResourceView* m_BombSummary;//背景画
