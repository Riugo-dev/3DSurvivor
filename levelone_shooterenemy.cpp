//********************************************************************************
//
// levelone_shooterenemy.cpp[レベル１射撃敵クラス]
//
//															Author :Riugo Honda
//															Date   :2025/10/06
//********************************************************************************
...
void LevelOneShooterEnemy::Init()
{
...
void LevelOneShooterEnemy::Uninit()
{
}

void LevelOneShooterEnemy::Update()
{
	if (!m_GetBig)
	{
...
void LevelOneShooterEnemy::Draw()
{
	Player* p_player = Manager::GetScene()->GetGameObject<Player>();
