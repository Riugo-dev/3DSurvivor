//********************************************************************************
//
// levelfive_shooterenemy.h[レベル5射撃敵クラス]
//
//															Author :Riugo Honda
//															Date   :2025/10/07
//********************************************************************************
...
void LevelFiveShooterEnemy::Init()
{
...
void LevelFiveShooterEnemy::Uninit()
{
}

void LevelFiveShooterEnemy::Update()
{
	if (!m_GetBig)
	{
	...
	if (m_FrameCount % m_ShotCoolDown == 0)
	{
		...
		bullet->Init();
		bullet->SetPosition({ m_Position.x , 1.25f , m_Position.z });
...
void LevelFiveShooterEnemy::Draw()
{
	Player* p_player = Manager::GetScene()->GetGameObject<Player>();
